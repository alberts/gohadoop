...
func (c *AMNMClient) StartContainer(container *hadoop_yarn.ContainerProto, containerLaunchContext *hadoop_yarn.ContainerLaunchContextProto) error {
	request := hadoop_yarn.StartContainersRequestProto{StartContainerRequest: []*hadoop_yarn.StartContainerRequestProto{{ContainerLaunchContext: containerLaunchContext, Container: container}}}
