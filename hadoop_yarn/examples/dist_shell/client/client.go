...
func main() {
	...
	clc.Command = []string{"/home/albert/h/appmaster 1>/tmp/stdout 2>/tmp/stderr"}
	//clc.Command = []string{"/usr/bin/uptime"}
	...
	log.Printf("Application finished in state: %v", appState)
}
